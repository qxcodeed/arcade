...
Você pode escolher **detonar apenas uma bomba**. Quando uma bomba é detonada, todas as bombas dentro do seu alcance também detonam. Essas bombas, por sua vez, detonam todas as bombas dentro de seus respectivos alcances. Retorne o **número máximo de bombas que podem ser detonadas** se você puder detonar apenas uma bomba inicialmente.

Segue uma representação visual do teste 1.
![](https://raw.githubusercontent.com/qxcodeed/arcade/main/labs/detonate/assets/image.png)
