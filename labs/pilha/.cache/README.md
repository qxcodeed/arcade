...
- Uma implementação eficiente da pilha pode ser efetuada sobre uma lista sequencial, por exemplo, a atividade [@vetbuild](https://github.com/qxcodeed/arcade/blob/main/labs/pilha/../vetbuild/README.md).
